...
|Name|Function Args|Optional Args|Return Type|
|:--|:--|:--|:--|
|ESSENCE_OF_CAIN_REVERT_PEDESTAL {: .copyable } | (Arg Name) | OptionalArg | Return |

### CALLBACK_NAME {: .copyable }

|Name|Function Args|Optional Args|Return Type|
|:--|:--|:--|:--|
|CALLBACK_NAME {: .copyable } | (Arg Name) | OptionalArg | Return |
...
Accepts returning `false` to prevent converting the pedestal, or a table of `{EntityType, integer Variant}` to convert the pedestal. `EntityType` can only be `EntityType.ENTITY_PICKUP` or `EntityType.ENTITY_SLOT`.

|Name|Function Args|Optional Args|Return Type|
|:--|:--|:--|:--|
|ESSENCE_OF_CAIN_REVERT_PEDESTAL {: .copyable } | (EntityPickup Pedestal) | - | boolean or table |
