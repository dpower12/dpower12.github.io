...
Can hold arbitrary data that is transferred over to [ThrownBagData.TransitionalData](ThrownBagData.md#transitionaldata) when the swung bag is thrown.
...
Extra damage to be added on top of ThrownDamage
