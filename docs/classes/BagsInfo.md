...
Number of extra items present in [BaggedItemsList](#baggeditemslist---aria-labelvariables-), as to not contribute to the amount of items needed to craft a new bag.
